 ...
 * generated in the org.js.rsi package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://rsi.js.org/", "getHelloWorldAsString");
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://rsi.js.org/", "getHelloWorldAsStringResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.js.rsi
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rsi.js.org/", name = "getHelloWorldAsString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rsi.js.org/", name = "getHelloWorldAsStringResponse")

 ...
 * generated in the com.mycompany.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetServerName_QNAME = new QName("http://ws.mycompany.com/", "getServerName");
    private final static QName _GetServerNameResponse_QNAME = new QName("http://ws.mycompany.com/", "getServerNameResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mycompany.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.mycompany.com/", name = "getServerName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.mycompany.com/", name = "getServerNameResponse")

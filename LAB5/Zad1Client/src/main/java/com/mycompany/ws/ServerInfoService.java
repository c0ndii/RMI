 ...
 * 
 */
@WebServiceClient(name = "ServerInfoService", targetNamespace = "http://ws.mycompany.com/", wsdlLocation = "http://desktop-peb2l7o:8080/Zad1/ServerInfoService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERINFOSERVICE_QNAME = new QName("http://ws.mycompany.com/", "ServerInfoService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://desktop-peb2l7o:8080/Zad1/ServerInfoService?wsdl");
    ...
    public ServerInfo getServerInfoPort() {
        return super.getPort(new QName("http://ws.mycompany.com/", "ServerInfoPort"), ServerInfo.class);
    }
    ...
    public ServerInfo getServerInfoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.mycompany.com/", "ServerInfoPort"), ServerInfo.class, features);
    }
